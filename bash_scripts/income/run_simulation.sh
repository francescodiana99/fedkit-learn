...
if [ "$split_criterion" = "correlation" ]; then
    state="louisiana"
    dirs="--chkpts_dir ./chkpts/$task_name/$state/heter/$heterogeneity/$batch_size/$local_epochs/ \
