...
if [ "$split_criterion" = "correlation" ]; then
            ...
            state="louisiana"
            dirs="--logs_dir ./logs/$task_name/$state/heter/$heterogeneity/$batch_size/$local_epochs/isolated/$attacked_round \
                ...
                --isolated_models_dir ./isolated/$task_name/$state/heter/$heterogeneity/$batch_size/$local_epochs/$attacked_round"

        elif [ "$split_criterion" = "state" ]; then
            state="full"
            dirs="--logs_dir ./logs/$task_name/$state/$batch_size/$local_epochs/isolated/$attacked_round \
                ...
                --isolated_models_dir ./chkpts/$task_name/$state/$batch_size/$local_epochs/$attacked_round"
        else
            dirs="--logs_dir ./logs/$task_name/$batch_size/$local_epochs/isolated/$attacked_round \
                ...
                --data_dir ./data/$task_name/tasks/$split_criterion/$state/$n_tasks/all \
