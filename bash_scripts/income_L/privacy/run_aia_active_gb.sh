...
logs_dir="./logs/seeds/$seed/privacy/$epsilon/$delta/$clip/income/$state/mixed/$mix_scaled/$n_tasks/$batch_size/$n_local_steps/$optimizer/active_${attacked_round}_gb_aia"
results_path="./results/seeds/$seed/privacy/$epsilon/$delta/$clip/income/$state/mixed/$mix_scaled/$n_tasks/$batch_size/$n_local_steps/$optimizer/active_${attacked_round}_gb_aia.json"
