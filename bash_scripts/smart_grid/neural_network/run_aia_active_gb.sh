...
logs_dir="./logs/seeds/$seed/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer/active_${attacked_round}_gb_aia"
results_path="./results/seeds/$seed/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer/active_${attacked_round}_gb_aia.json"
