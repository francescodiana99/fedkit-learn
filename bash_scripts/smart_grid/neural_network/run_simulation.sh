...
chkpts_dir="./chkpts/seeds/$seed/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer"
logs_dir="./logs/seeds/$seed/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer"
