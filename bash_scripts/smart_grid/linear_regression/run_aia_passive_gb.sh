...
logs_dir="./logs/seeds/$seed/linear/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer/gb_aia"
results_path="./results/seeds/$seed/linear/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer/gb_aia.json"
