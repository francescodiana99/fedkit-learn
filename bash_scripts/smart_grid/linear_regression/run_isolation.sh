...
logs_dir="./logs/seeds/$seed/linear/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer/isolated"
iso_chkpts_dir="./chkpts/seeds/$seed/linear/smart_grid/$n_tasks/$batch_size/$n_local_steps/$optimizer/isolated"
