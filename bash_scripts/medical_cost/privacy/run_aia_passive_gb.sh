...
logs_dir="./logs/seeds/$seed/privacy/$epsilon/$delta/$clip/medical_cost/$n_tasks/$batch_size/$n_local_steps/$optimizer/gb_aia"
results_path="./results/seeds/$seed/privacy/$epsilon/$delta/$clip/medical_cost/$n_tasks/$batch_size/$n_local_steps/$optimizer/gb_aia.json"
