...
results_dir="./results/seeds/$seed/linear/medical_cost/$n_tasks/$batch_size/$n_local_steps/$optimizer/reconstructed"
reconstructed_models_dir="./reconstructed_models/seeds/$seed/linear/medical_cost/$n_tasks/$batch_size/$n_local_steps/$optimizer"
